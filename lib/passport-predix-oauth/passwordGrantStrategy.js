...
function Password(options, verify) {
    options = options || {};
...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  this._oauth2.getOAuthAccessToken('', { grant_type: 'password',username:'user',password:'password', redirect_uri: callbackURL },
